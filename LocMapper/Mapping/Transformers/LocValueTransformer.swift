...
open class LocValueTransformer : CustomStringConvertible {
	...
	/**
	 ...
	 Cannot fail because if the serialization is invalid, will return a LocValueTransformerInvalid that will simply hold the serialization and will not do any transform.
